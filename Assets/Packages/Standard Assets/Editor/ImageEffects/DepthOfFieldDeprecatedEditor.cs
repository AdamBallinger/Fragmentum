    ...
    class DepthOfFieldDeprecatedEditor : Editor
    {
        ...
        public override void OnInspectorGUI () {
            ...
            if (simpleTweakMode.boolValue) {
                ...
                focalStartCurve.floatValue = EditorGUILayout.Slider ("Start defaultCurve", focalStartCurve.floatValue, 0.05f, 20.0f);
                focalEndCurve.floatValue = EditorGUILayout.Slider ("End defaultCurve", focalEndCurve.floatValue, 0.05f, 20.0f);
            }
